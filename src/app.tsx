          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <input disabled={isGuestsInputOpen} type="text" placeholder="Quando?"
                className="bg-transparent placeholder-zinc-400 w-40 outline-none"
              />
            </div>
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestsInput}
                className="bg-zinc-800 text-zinc-200 rounded-lg py-2 px-5 font-medium flex items-center gap-2 transition-all hover:bg-zinc-700">
                Alterar Local/Data
                <Settings2 className="size-5" />
              </button>
            ) : (
              <button onClick={openGuestsInput}
                className="bg-lime-300 text-lime-950 rounded-lg py-2 px-5 font-medium flex items-center gap-2 transition-all hover:bg-lime-400">
                Continuar
